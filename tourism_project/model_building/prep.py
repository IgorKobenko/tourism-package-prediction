...
# Loads raw data from the HF dataset space, cleans it, splits it
...
# Defensive imputation so the automated pipeline never fails on new data:
...
# ----------------------- 3. TRAIN / TEST SPLIT ---------------------
target_col = "ProdTaken"   # 1 = purchased the package, 0 = did not
